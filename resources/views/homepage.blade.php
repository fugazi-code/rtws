...
<div class="navbar navbar-default navbar-fixed-top">
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a href="index.html" class="navbar-brand"><span>Broom</span> Express</a>
		</div>
	...
	<div class="container">
		<div class="row">
               ...
               <div class="wow fadeInUp col-md-6 col-sm-5 col-xs-10 col-xs-offset-1 col-sm-offset-0" data-wow-delay="0.2s">
                    <img src="img/home-img.png" class="img-responsive" alt="Home">
               </div>
     ...
     <div class="container">
          <div class="row">
               ...
               <div class="wow fadeInUp col-md-6 col-sm-12" data-wow-delay="0.4s">
                   <h2>Broom Express</h2>
                   <h3 class="wow fadeInUp" data-wow-delay="0.8s">The Broom Express is a local group of company that provides on same day delivery by connecting users with delivery drivers on its mobile and web application.</h3>
          ...
          <div class="row">
               ...
               <div id="screenshot-carousel" class="owl-carousel">
                    ...
                    <div class="item col-md-3 col-sm-3 wow fadeInUp" data-wow-delay="0.9s">
                         <a href="img/screenshot-img1.jpg" class="image-popup">
                              <img src="img/1.png" class="img-responsive" alt="screenshot">
                         </a>
                    </div>

                    <div class="item col-md-3 col-sm-3 wow fadeInUp" data-wow-delay="0.9s">
                         <a href="img/screenshot-img2.jpg" class="image-popup">
                              <img src="img/2.png" class="img-responsive" alt="screenshot">
                         </a>
                    </div>

                    <div class="item col-md-3 col-sm-3 wow fadeInUp" data-wow-delay="0.9s">
                         <a href="img/screenshot-img3.jpg" class="image-popup">
                              <img src="img/3.png" class="img-responsive" alt="screenshot">
                         </a>
                    </div>

                    <div class="item col-md-3 col-sm-3 wow fadeInUp" data-wow-delay="0.9s">
                         <a href="img/screenshot-img4.jpg" class="image-popup">
                              <img src="img/5.png" class="img-responsive" alt="screenshot">
                         </a>
                    </div>

                    <div class="item col-md-3 col-sm-3 wow fadeInUp" data-wow-delay="0.9s">
                         <a href="img/screenshot-img5.jpg" class="image-popup">
                              <img src="img/4.png" class="img-responsive" alt="screenshot">
                         </a>
                    </div>

                    <div class="item col-md-3 col-sm-3 wow fadeInUp" data-wow-delay="0.9s">
                         <a href="img/screenshot-img6.jpg" class="image-popup">
                              <img src="img/6.png" class="img-responsive" alt="screenshot">
                         </a>
                    </div>

                    <div class="item col-md-3 col-sm-3 wow fadeInUp" data-wow-delay="0.9s">
                         <a href="img/screenshot-img7.jpg" class="image-popup">
                              <img src="img/7.png" class="img-responsive" alt="screenshot">
                         </a>
                    </div>

                    <div class="item col-md-3 col-sm-3 wow fadeInUp" data-wow-delay="0.9s">
                         <a href="img/screenshot-img8.jpg" class="image-popup">
                              <img src="img/8.png" class="img-responsive" alt="screenshot">
                         </a>
                    </div>
...
<section id="pricing">
     <div class="container">
          <div class="row">
               ...
               <div class="wow fadeInUp col-md-4 col-sm-5" data-wow-delay="0.4s">
                    <div class="pricing-plan">
                         ...
                         <img src="img/package.jpg" style="height: 230px;">
                         <!-- <p>40 Users</p>
                         <p>10GB per user</p>
		...
		<div class="row">
               ...
               <div class="col-md-8 col-sm-6">
                    <div class="wow fadeInUp footer-copyright" data-wow-delay="0.4s">
                         <h6>
                             <span style="color: red;"> Copyright ©<script>document.write(new Date().getFullYear()); </style> </script>2020<span style="color: white;"> Yaramay Computer Maintenance Services.</span> All rights reserved</h6>
